...
public record SsadaguSummaryResponse(
        ...
        @Schema(description = "AI가 생성한 홍보용 제목", example = "이 가을 필수템, 에어맥스 운동화")
        String title,
    ...
    public static SsadaguSummaryResponse from(SsadaguProductDto product, String title, String summary) {
        return new SsadaguSummaryResponse(product, title, summary);
    }
}
